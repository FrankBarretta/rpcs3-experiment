...
public:
	...
	const struct settings
	{
		...
		const QString aspect_ratio               = tr("Controls the presentation aspect ratio. Ultra-wide ratios use a wider output area; games need native support or patches to render extra horizontal scene content instead of a wider 16:9 image.");
		...
		const QString ultra_wide_screen          = tr("Shortcut for selecting an ultra-wide aspect ratio. It defaults to 32:9 for displays such as 5120x1440; use the Aspect ratio dropdown for 21:9 or 48:9.");
